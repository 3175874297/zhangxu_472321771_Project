    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="题集表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" placeholder="请选择题集表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题集名称" prop="exampaperName">
                        <el-input v-model="exampaperForm.exampaperName"
                                  placeholder="题集名称" clearable  :readonly="ro.exampaperName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题集名称" prop="exampaperName">
                            <el-input v-model="ruleForm.exampaperName"
                                      placeholder="题集名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="总分数" prop="exampaperMyscore">
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="总分数" clearable  :readonly="ro.exampaperMyscore"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="总分数" prop="exampaperMyscore">
                            <el-input v-model="ruleForm.exampaperMyscore"
                                      placeholder="总分数" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题集编号" prop="examrecordUuidNumber">
                        <el-input v-model="ruleForm.examrecordUuidNumber"
                                  placeholder="题集编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题集编号" prop="examrecordUuidNumber">
                            <el-input v-model="ruleForm.examrecordUuidNumber"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    yonghuId: [
                        { required: true, message: '练习学生不能为空', trigger: 'blur' },
                    ],
                    exampaperId: [
                        { required: true, message: '所属题集id（外键）不能为空', trigger: 'blur' },
                    ],
                    totalScore: [
                        { required: true, message: '所得总分不能为空', trigger: 'blur' },
                    ],
                    insertTime: [
                        { required: true, message: '练习时间不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
