    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="24">
                    <el-form-item class="select" v-if="type!='info'"  label="习题类别" prop="examquestionTypes">
                        <el-select @change="typeChange" v-model="ruleForm.examquestionTypes" :readonly="ro.examquestionTypes" placeholder="请选择习题类别">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="习题类别" prop="examquestionValue">
                            <el-input v-model="ruleForm.examquestionValue"
                                      placeholder="习题类别" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    examquestionTypes: [
                        { required: true, message: '习题类别不能为空', trigger: 'blur' },
                    ],
                    examquestionSequence: [
