    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="习题表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" placeholder="请选择习题表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="练习时长(分钟)" prop="exampaperDate">
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="练习时长(分钟)" clearable  :readonly="ro.exampaperDate" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="练习时长(分钟)" prop="exampaperDate">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="习题总分数" prop="exampaperMyscore">
                        <el-input v-model="exampaperForm.exampaperMyscore"
                                  placeholder="习题总分数" clearable  :readonly="ro.exampaperMyscore" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="习题总分数" prop="exampaperMyscore">
                            <el-input v-model="ruleForm.exampaperMyscore"
                                      placeholder="习题总分数" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="习题表" prop="examquestionId">
                        <el-select v-model="ruleForm.examquestionId" placeholder="请选择习题表" @change="examquestionChange">
                            <el-option
                                    v-for="(item) in examquestionOptions"
                                    v-bind:key="item.id"
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="习题名称" prop="examquestionName">
                        <el-input v-model="examquestionForm.examquestionName"
                                  placeholder="习题名称" clearable  :readonly="ro.examquestionName" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="习题名称" prop="examquestionName">
                            <el-input
                                    type="textarea"
                                    min="1"
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="习题排序" prop="examquestionSequence">
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="习题排序，值越大排越前面" clearable  :readonly="ro.examquestionSequence" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="习题排序" prop="examquestionSequence">
                            <el-input v-model="ruleForm.examquestionSequence"
                                      placeholder="习题排序，值越大排越前面" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    exampaperId: [
                        { required: true, message: '习题（外键）不能为空', trigger: 'blur' },
                    ],
                    examquestionId: [
                        { required: true, message: '习题id（外键）不能为空', trigger: 'blur' },
                    ],
                    examredetailsMyanswer: [
