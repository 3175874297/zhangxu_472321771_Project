<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="题集编号" prop="examredetailsUuidNumber">
                        <el-input v-model="ruleForm.examredetailsUuidNumber"
                                  placeholder="题集编号" clearable  :readonly="ro.examredetailsUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题集编号" prop="examredetailsUuidNumber">
                            <el-input v-model="ruleForm.examredetailsUuidNumber"
                                      placeholder="题集编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="习题排序" prop="examquestionSequence">
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="习题排序，值越大排越前面" clearable  :readonly="ro.examquestionSequence"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="习题排序" prop="examquestionSequence">
                            <el-input v-model="ruleForm.examquestionSequence"
                                      placeholder="习题排序，" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="习题得分" prop="examredetailsMyscore">
                        <el-input v-model="ruleForm.examredetailsMyscore"
                                  placeholder="习题得分" clearable  :readonly="ro.examredetailsMyscore"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="习题得分" prop="examredetailsMyscore">
                            <el-input v-model="ruleForm.examredetailsMyscore"
                                      placeholder="习题得分" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    examredetailsUuidNumber: [
                        { required: true, message: '题集编号不能为空', trigger: 'blur' },
                    ],
                    yonghuId: [
                    ...
                    examredetailsMyscore: [
                        { required: true, message: '习题得分不能为空', trigger: 'blur' },
                    ],
                }
            };
        },
